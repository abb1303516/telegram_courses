...
- Веб-интерфейс — открывается в браузере по IP:PORT
- Просмотр видео прямо в браузере (стриминг)
- Скачивание файлов по одному или архивом (ZIP)
- Докачка — при повторном запуске не качает то, что уже скачано
- Фильтрация файлов по типу (видео / аудио / документы / фото)
...
1. Открывает `http://ip:порт` в браузере (или из закладки)
2. Вводит пароль
3. Видит список курсов → выбирает нужный
4. Нажимает **⬇️ Скачать** на нужный файл
5. Или **📦 Скачать всё архивом** — получает ZIP
